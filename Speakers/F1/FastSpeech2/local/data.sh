...
F1_B2_Greek-F1-B2-03-14
F1_B2_Greek-F1-B2-30-01
F1_B2_Greek-F1-B2-36-14
F1_C1_Greek-F1-C1-01-10
F1_C1_Greek-F1-C1-15-22
F1_C1_Greek-F1-C1-27-23
F1_C2_Greek-F1-C2-01-04
F1_C2_Greek-F1-C2-24-01
F1_C2_Greek-F1-C2-51-12
F1_Harvard_Greek-F1-Harvard-05-19
F1_Harvard_Greek-F1-Harvard-18-12
F1_Harvard_Greek-F1-Harvard-29-12
EOF
    # ----------------------------------
    ...
    for subset in "${subsets[@]}"; do
        for spk in "${speakers[@]}"; do
            ...
            find "${audio_root}" -name "*.wav" | sort | while read -r wav_path; do
                ...
                base_text_id=$(echo "${filename}" | sed -E 's/-(M1|F1|F2|M|F)//')
